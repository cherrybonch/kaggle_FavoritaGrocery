...
library(ggplot2)
library(scales)
holidays_events <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/holidays_events.csv")
items <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/items.csv")
oil <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/oil.csv")
sample_submission <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/sample_submission.csv")
stores <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/stores.csv")
test <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/test.csv")
train <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/train.csv",nrows = 100000)
transactions <- fread("C:/OwnCloud/Kaggle/CorporacionFavorita/transactions.csv")
```
...
* *train.csv, test.csv*  
?????????????????????????
Choose 1 relatively popular item that was on promotion and plot its total sales in all stores from 2016-08-16 to 2017-08-15, setting color to show onpromotion.
